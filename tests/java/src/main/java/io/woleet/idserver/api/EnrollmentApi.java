...
public class EnrollmentApi {
     ...
     */
    public List<EnrollmentGet> getEnrollments() throws ApiException {
        ApiResponse<List<EnrollmentGet>> localVarResp = getEnrollmentsWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<EnrollmentGet>> getEnrollmentsWithHttpInfo() throws ApiException {
    ...
    /**
     * Get all key enrollment requests. (asynchronously)
     * 
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call getEnrollmentsAsync(final ApiCallback<List<EnrollmentGet>> _callback) throws ApiException {
