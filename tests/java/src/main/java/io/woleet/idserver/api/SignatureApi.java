...
public class SignatureApi {
     ...
     */
    public okhttp3.Call getSignatureCall(String hashToSign, UUID userId, String customUserId, String pubKey, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getSignatureValidateBeforeCall(String hashToSign, UUID userId, String customUserId, String pubKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getSignatureCall(hashToSign, userId, customUserId, pubKey, _callback);
        return localVarCall;
    ...
    public SignatureResult getSignature(String hashToSign, UUID userId, String customUserId, String pubKey) throws ApiException {
        ApiResponse<SignatureResult> localVarResp = getSignatureWithHttpInfo(hashToSign, userId, customUserId, pubKey);
    ...
    public ApiResponse<SignatureResult> getSignatureWithHttpInfo(String hashToSign, UUID userId, String customUserId, String pubKey) throws ApiException {
        okhttp3.Call localVarCall = getSignatureValidateBeforeCall(hashToSign, userId, customUserId, pubKey, null);
     ...
     */
    public okhttp3.Call getSignatureAsync(String hashToSign, UUID userId, String customUserId, String pubKey, final ApiCallback<SignatureResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSignatureValidateBeforeCall(hashToSign, userId, customUserId, pubKey, _callback);
        Type localVarReturnType = new TypeToken<SignatureResult>(){}.getType();
