...
public class SignatureApi {
     ...
     * @param customUserId Custom user identifier (ie. &#x60;userId&#x60; field of the user identity). (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Successful operation. The produced signature and its associated parameters are returned as a JSON object&lt;br&gt; Note that if your are using the Woleet API and you want to anchor this signature, you can simply add a &#x60;name&#x60; field to the returned JSON object, and provide it as is to the &#x60;POST /anchor&#x60; endpoint.  </td><td>  -  </td></tr>
