...
public class KeyApi {
     ...
     */
    public okhttp3.Call getUserKeysCall(UUID userId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUserKeysValidateBeforeCall(UUID userId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new ApiException("Missing the required parameter 'userId' when calling getUserKeys(Async)");
        }
        

        okhttp3.Call localVarCall = getUserKeysCall(userId, _callback);
        return localVarCall;
     ...
     */
    public List<KeyGet> getUserKeys(UUID userId) throws ApiException {
        ApiResponse<List<KeyGet>> localVarResp = getUserKeysWithHttpInfo(userId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<KeyGet>> getUserKeysWithHttpInfo(UUID userId) throws ApiException {
        okhttp3.Call localVarCall = getUserKeysValidateBeforeCall(userId, null);
        Type localVarReturnType = new TypeToken<List<KeyGet>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get all the keys of a user. (asynchronously)
     * 
     * @param userId Identifier of the user. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getUserKeysAsync(UUID userId, final ApiCallback<List<KeyGet>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUserKeysValidateBeforeCall(userId, _callback);
        Type localVarReturnType = new TypeToken<List<KeyGet>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
