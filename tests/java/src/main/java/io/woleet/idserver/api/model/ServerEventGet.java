...
public class ServerEventGet {
  ...
  **/
  ...
  public ServerEventGet authorizedTokenId(UUID authorizedTokenId) {
   ...
   /**
   * Identifier of the API token used to authenticate.
   * @return authorizedTokenId
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "fd7cb389-91e6-41ba-a0a5-14a05bd2b5f7", value = "Identifier of the API token used to authenticate.")
