...
public class IdentityApi {
     ...
     * @param signedIdentity Identity to verify (as a X500 Distinguished Name).&lt;br&gt; This identity must have been signed at least once by the public key.  (optional)
     ...
     */
    public okhttp3.Call getIdentityCall(String pubKey, String signedIdentity, String leftData, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getIdentityValidateBeforeCall(String pubKey, String signedIdentity, String leftData, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getIdentityCall(pubKey, signedIdentity, leftData, _callback);
        return localVarCall;
     ...
     */
    public IdentityResult getIdentity(String pubKey, String signedIdentity, String leftData) throws ApiException {
        ApiResponse<IdentityResult> localVarResp = getIdentityWithHttpInfo(pubKey, signedIdentity, leftData);
     ...
     */
    public ApiResponse<IdentityResult> getIdentityWithHttpInfo(String pubKey, String signedIdentity, String leftData) throws ApiException {
        okhttp3.Call localVarCall = getIdentityValidateBeforeCall(pubKey, signedIdentity, leftData, null);
     ...
     */
    public okhttp3.Call getIdentityAsync(String pubKey, String signedIdentity, String leftData, final ApiCallback<IdentityResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = getIdentityValidateBeforeCall(pubKey, signedIdentity, leftData, _callback);
        Type localVarReturnType = new TypeToken<IdentityResult>(){}.getType();
