...
public class IdentityApi {
     ...
     */
    public okhttp3.Call getIdentityCall(String pubKey, String leftData, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getIdentityValidateBeforeCall(String pubKey, String leftData, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getIdentityCall(pubKey, leftData, _callback);
        return localVarCall;
    ...
    public IdentityResult getIdentity(String pubKey, String leftData) throws ApiException {
        ApiResponse<IdentityResult> localVarResp = getIdentityWithHttpInfo(pubKey, leftData);
    ...
    public ApiResponse<IdentityResult> getIdentityWithHttpInfo(String pubKey, String leftData) throws ApiException {
        okhttp3.Call localVarCall = getIdentityValidateBeforeCall(pubKey, leftData, null);
     ...
     */
    public okhttp3.Call getIdentityAsync(String pubKey, String leftData, final ApiCallback<IdentityResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = getIdentityValidateBeforeCall(pubKey, leftData, _callback);
        Type localVarReturnType = new TypeToken<IdentityResult>(){}.getType();
