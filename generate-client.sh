...
$OPENAPI_CODEGEN generate -i swagger.yaml -g java -p hideGenerationTimestamp=true -o tests/java --api-package io.woleet.idserver.api --artifact-id woleet-idserver-api-client --group-id io.woleet.idserver --model-package io.woleet.idserver.api.model --artifact-version 1.0.0
